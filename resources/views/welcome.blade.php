...
<div class="row mb-4">
            ...
            <form action="" method="post">
                ...
                <div class="row">
                    <div class="form-group col-md-6 col-lg-6">
                        ...
                        <input type="text" placeholder="Origin city" class="form-control"
                            name="origin_city" v-model="Shipment.origin_city">
                    </div>
                    <div class="form-group col-md-6 col-lg-6">
                        <label for="">Origin Country</label>
                        <input type="text" placeholder="Origin country" class="form-control"
                            name="origin_country" v-model="Shipment.origin_country">
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-md-6 col-lg-6">
                        <label for="">Destination city</label>
                        <input type="text" placeholder="Destination city" class="form-control"
                            name="destination_city" v-model="Shipment.destination_city">
                    </div>
                    <div class="form-group col-md-6 col-lg-6">
    ...
    <div class="card col-md-7 col-lg-7">
        <div class="card-header bg-primary text-white">
            Item information
            <button class="btn btn-success float-right" @click.prevent="SaveShipment()" v-if="Shipment.items.length > 0"> <i class="fas fa-save"></i> Save </button>
            <button class="btn btn-success float-right" disabled="true" v-else > <i class="fas fa-save"></i> Save </button>
        </div>
        <div class="card-body">
            ...
            <div class="row">
                <div class="form-group col-md-12 col-lg-12">
                    ...
                    <textarea name="item_remarks" name="item_remarks" cols="30" rows="3"
                    style="resize: none"  class="form-control" placeholder="Remarks"
                    v-model="ItemForm.item_remarks"></textarea>
                </div>
            </div>
